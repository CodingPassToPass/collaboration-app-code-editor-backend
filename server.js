...
io.on("connection", ( socket)=>{
    ...
    //(4). user disconnected or close the tab
    ...
    socket.on(CODE_CHANGE, ({ name, roomId, code, selectedLanguage})=>{
    ...
    socket.on(SELECT_DIFFERENT_LANGUAGE, ({ roomId, selectedLanguage})=>{
